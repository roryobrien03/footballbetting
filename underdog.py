...
def hometeamwin():
    ...
    return print(f"Return = ${win1}"), print(f"ROI = {win1*(100/380)}")
...
def awayteamwin():
    ...
    return print(f"Return = ${win2}"), print(f"ROI = {win2*(100/380)} %")
...
def draw():
    ...
    return print(f"Return = ${draw1}"), print(f"ROI = {draw1*(100/380)} %")
...
def underdog():
    ...
    return print(f"Return = ${underdog}") , print(f"ROI = {underdog*(100/380)} %")
...
def favourite():
    ...
    return print(f"Return = ${favourite}") , print(f"ROI = {favourite*(100/380)} %")
...
def teampickfunction():
    ...
    return print(f"Return = ${teamreturn}"), print(f"ROI = {teamreturn*(100/38)} %")         
